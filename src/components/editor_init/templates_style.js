...
const templates_style = (username,pin) => {
  ...
  templates: [
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; width: 100%;" width="100%">
                          <tr>
                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                              <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">👋&nbsp; Welcome to {$username}.</p>
                              <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">👋&nbsp; your pin is {$pin}.</p>
    ...
    },
    {
      ...
      content: "<p>Name: {$username}, StaffID: {$pin}</p>",
    },
    {
      title: "Cdate",
      description: "cdate",
